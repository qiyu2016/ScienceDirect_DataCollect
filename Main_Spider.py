...
from query_split import query_noun
...
#                abstract_cn = self.translate.en2ch(abstract_en)
                ...
                self.write_to_file.write_to_txt(KeyWords,count,title_en,abstract_en,new_url)
...
if __name__ == "__main__":
    ...
    document = open('D:/knowledge_network/paper_3_travelingwave/crawler/design_problem.txt', encoding='utf8').read()
